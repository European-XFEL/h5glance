...
def fill_file(f: h5py.File):
    ...
    f.create_dataset('compound', data=numpy.array(
        [(1, 0.5), (3, 0.090)], dtype=numpy.dtype([('count', 'u8'), ('amount', 'f4')])
    ))
    f.create_dataset('prose', data=numpy.array(
